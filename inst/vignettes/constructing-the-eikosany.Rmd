...
eikosany_harmonics <- c(1, 3, 5, 7, 9, 11)
eikosany_choose <- 3
eikosany <- scale_table(
  eikosany_harmonics, eikosany_choose, middle_c_freq, middle_c_note_number
  )

dekany_harmonics <- c(1, 7, 9, 11, 13)
dekany_choose <- 2
dekany <- scale_table(
  dekany_harmonics, dekany_choose, middle_c_freq, middle_c_note_number
  )
stop()
