...
::: {.incremental}
- Microtonal harmonic structure is Harry Partch's Tonality
Diamond [@partch1979genesis]
- Tonality Diamond was an inspiration for Erv Wilson's
...
## Combination Product Sets [@narushima2019microtonality, chapter 6] {.smaller}
::: {.incremental}
...
- The prime on the bottom `note_name` indicates the next octave
...
- These slides: <https://github.com/AlgoCompSynth/eikosany/tree/main/inst/Eikosany-Cascadia-R-Conference-Slides>
